$(document).ready(function() {
  ...
  $('.pic_holder').append("<video class='pic pic23' autoplay loop muted controls><source src='pics/vid1.mp4' type='video/mp4'>Your browser does not support the video tag.</video>");
  $('.pic_holder').append("<video class='pic pic24' autoplay loop muted controls><source src='pics/vid2.mp4' type='video/mp4'>Your browser does not support the video tag.</video>");
